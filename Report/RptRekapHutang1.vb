...
Public Class RptRekapHutang1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIS.RptRekapHutang1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRekapHutang1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRekapHutang1 = New RptRekapHutang1()
        rpt.Site = Me.Site
        Return rpt
    End Function
