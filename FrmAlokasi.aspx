<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmAlokasi.aspx.vb" Inherits="AIS.FrmAlokasi" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Daftar Alokasi</td>
</tr>
</table>
</div>
...
<tr>
    ...
    <td>    
        <asp:TextBox ID="TxtAlokasi" runat="server" Width="30px" autocomplete="off" 
            MaxLength="1" CssClass="font1" TabIndex="1"></asp:TextBox>
    </td>
</tr>
<tr>
    <td>Keterangan</td>
    <td style="text-align:center">:</td>
    <td>
        <asp:TextBox ID="TxtKeterangan" runat="server" Width="500px" autocomplete="off" CssClass="font1" MaxLength="200" TabIndex="2"></asp:TextBox>
    </td>
</tr>
<tr>
    <td>
