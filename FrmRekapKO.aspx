<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmRekapKO.aspx.vb" Inherits="AIS.FrmRekapKO" %>
...
<div class="title" 
        style="border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #C0C0C0; margin-bottom: 5px;">Rekap KO</div>
...
<tr>
    ...
    <td>:</td>
    <td colspan="3">
        <dx:ASPxComboBox ID="DDLJob" runat="server" ValueType="System.String" Width="100%" 
...
<tr>
    ...
    <td>:</td>
    <td>
        <dx:ASPxDateEdit ID="PrdAwal" runat="server" DisplayFormatString="dd-MMM-yyyy" 
    ...
    <td>s.d.</td>
    <td>
        <dx:ASPxDateEdit ID="PrdAkhir" runat="server" DisplayFormatString="dd-MMM-yyyy" 
            Theme="MetropolisBlue">
