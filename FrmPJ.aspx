<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmPJ.aspx.vb" Inherits="AIS.FrmPJ" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Daftar Pertanggungjawaban Dana</td>
</tr>
</table>
</div>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="PjApprovedByAK" HeaderText="PJ Approved By (AK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="PjTimeApprovedAK" HeaderText="PJ Approved On (AK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
