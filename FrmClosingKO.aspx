<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmClosingKO.aspx.vb" Inherits="AIS.FrmClosingKO" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Penutupan Kontrak</td>
</tr>
</table>
</div>
...
<td>
    <asp:GridView ID="GridData" runat="server" AutoGenerateColumns="False"               
        ...
        <Columns>                        
            ...
            <asp:BoundField DataField="PaymentAmount" HeaderText="Telah Terbayar (Rp)" HeaderStyle-Width="150px" ItemStyle-Width = "150px" 
                DataFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right">                    
            </asp:BoundField>
            <asp:BoundField DataField="ClosedBy" HeaderText="Kontrak Ditutup Oleh" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
            </asp:BoundField>
            <asp:BoundField DataField="TimeClosed" HeaderText="Kontrak Ditutup Pada" HeaderStyle-Width="100px" ItemStyle-Width = "100px"
                DataFormatString="{0:dd-MMM-yyyy}">                        
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:ButtonField CommandName="BtnUpdate" Text="SELECT"  HeaderStyle-Width="45px" />                                          
            <asp:ButtonField CommandName="BtnClose" Text="CLOSE" HeaderStyle-Width="45px" />   
        </Columns>
