<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmApprovalPD_DP.aspx.vb" Inherits="AIS.FrmApprovalPD_DP" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Approval Permintaan Dana (DP)</td>
</tr>
</table>
</div>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="ApprovedByDP" HeaderText="PD Approved By (DP)" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="TimeApprovedDP" HeaderText="PD Approved On (DP)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
