<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmPD.aspx.vb" Inherits="AIS.FrmPD" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Daftar Permintaan Dana</td>
</tr>
</table>
</div>
...
<td style="padding-top:10px">
    <dx:ASPxButton ID="BtnAdd" runat="server" Text="TAMBAH PD" 
        Theme="MetropolisBlue">
    </dx:ASPxButton>
</td>
<td style="padding-top:10px">
    <dx:ASPxButton ID="BtnAddKso" runat="server" Text="TAMBAH PDRKD" 
        Theme="MetropolisBlue">
    </dx:ASPxButton>
</td>
<td style="padding-top:10px">
    <dx:ASPxButton ID="BtnAddMix" runat="server" Text="TAMBAH PDMIX" 
        Theme="MetropolisBlue">
    </dx:ASPxButton>
</td>
<td style="padding-top:10px">
    <dx:ASPxCheckBox ID="CbViewMix" runat="server" Text="Tampilkan hanya PDMIX" Theme="MetropolisBlue" AutoPostBack="true">
    </dx:ASPxCheckBox>
</td>
</tr>
</table>
...
<tr>
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                <asp:BoundField DataField="NoPD" HeaderText="No. PD" HeaderStyle-Width="130px" ItemStyle-Width = "130px" SortExpression="NoPD">      
                </asp:BoundField>
                <asp:BoundField DataField="NoRef" HeaderText="No. Ref Lapangan" HeaderStyle-Width="80px" ItemStyle-Width = "80px" SortExpression="NoRef">                    
                </asp:BoundField>
                <asp:BoundField DataField="TglPD" HeaderText="Tgl PD" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}" SortExpression="TglPD">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="Alokasi" HeaderText="Alokasi" HeaderStyle-Width="50px" ItemStyle-Width = "50px" 
                ItemStyle-HorizontalAlign="Center" SortExpression="Alokasi">                    
                </asp:BoundField>
                <asp:BoundField DataField="TipeForm" HeaderText="Tipe Form" HeaderStyle-Width="50px" ItemStyle-Width = "50px" 
                ItemStyle-HorizontalAlign="Center" SortExpression="TipeForm">                    
                </asp:BoundField>
                <asp:BoundField DataField="NoKO" HeaderText="No KO" HeaderStyle-Width="50px" ItemStyle-Width = "50px" 
                ItemStyle-HorizontalAlign="Center" SortExpression="NoKO">                    
                </asp:BoundField>
                <asp:BoundField DataField="Deskripsi" HeaderText="Deskripsi" HeaderStyle-Width="350px" ItemStyle-Width = "350px" SortExpression="Deskripsi"/>
                <asp:BoundField DataField="TotalPD" HeaderText="Total PD (Rp)" HeaderStyle-Width="100px" ItemStyle-Width = "100px"
                    DataFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right" SortExpression="TotalPD">                        
                </asp:BoundField>
                <asp:BoundField DataField="ApprovedByAK" HeaderText="PD Approved By (AK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px" SortExpression="ApprovedByAK">                     
                </asp:BoundField>
                <asp:BoundField DataField="TimeApprovedAK" HeaderText="PD Approved On (AK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}" SortExpression="TimeApprovedAK">                        
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
