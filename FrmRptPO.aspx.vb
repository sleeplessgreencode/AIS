Public Class FrmRptPO
    ...
    Private Sub BindReport()
        ...
        Using CmdReport As New Data.SqlClient.SqlCommand
            With CmdReport
                ...
                .CommandText = "SELECT A.NoKO AS NoKO, A.*, B.*, C.JobNm, C.CompanyId, C.Logo " & _
                                "FROM (KoHdr A " & _
                    ...
                    Using Rpt As New RptPO
                        With Rpt
                            ...
                            Using RsLoad As Data.SqlClient.SqlDataReader = CmdReport.ExecuteReader
                                If RsLoad.Read Then
                                    .SetParameterValue("@NoKO", If(RsLoad("AddendumKe") > 0, RsLoad("NoKO") + " REV " + RsLoad("AddendumKe").ToString, RsLoad("NoKO")))
                                    .SetParameterValue("@TglKO", RsLoad("TglKO"))
                                    .SetParameterValue("@JobNo", RsLoad("JobNo") & " - " & RsLoad("JobNm"))
                                    .SetParameterValue("@AlamatKirim", RsLoad("AlamatKirim").ToString)
                                    .SetParameterValue("@NamaKirim", RsLoad("NamaKirim").ToString)
                                    .SetParameterValue("@TeleponKirim", RsLoad("TeleponKirim").ToString)
                                    .SetParameterValue("@MaterialApproval", If(RsLoad("MaterialApproval").ToString = "1", Chr(254).ToString, Chr(168).ToString))
                                    .SetParameterValue("@RAP", If(RsLoad("RAP").ToString = "1", Chr(254).ToString, Chr(168).ToString))
                                    .SetParameterValue("@K3", If(RsLoad("K3").ToString = "1", Chr(254).ToString, Chr(168).ToString))
                                    ...
                                    .SetParameterValue("@DiscAmount", RsLoad("DiscAmount"))
                                    .SetParameterValue("@PPN", RsLoad("PPN"))
                                    ...
                                    Using CmdFind As New Data.SqlClient.SqlCommand
                                        With CmdFind
                                            .Connection = Conn
                                            .CommandType = CommandType.Text
                                            .CommandText = "SELECT * FROM Vendor A WHERE VendorId=@P1"
                                        ...
                                        Using RsFind As Data.SqlClient.SqlDataReader = CmdFind.ExecuteReader
                                            If RsFind.Read Then
                                                ...
                                                .SetParameterValue("@ContactPerson", If(String.IsNullOrEmpty(RsFind("ContactPerson").ToString) = False, RsFind("ContactPerson").ToString, "-"))
                                            End If
                                        End Using
                                    End Using

                                    Jumlah = Jumlah - RsLoad("DiscAmount") + RsLoad("PPN")
    ...
    Private Function GenerateQRImage(NoKO As String, code As String)
        Dim Image As String = ""
