<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmRejectPD.aspx.vb" Inherits="AIS.FrmRejectPD" %>
...
<div>
    <dx:ASPxPopupControl ID="DelMsg" runat="server" CloseAction="CloseButton" Modal="True"
        ...
        HeaderText="Reject Confirmation" PopupAnimationType="Fade" EnableViewState="False" 
            Width="700px" PopupElementID="DelMsg" CloseOnEscape="True" 
        Theme="MetropolisBlue">
        <ClientSideEvents Init="function(s, e) { BtnCancel.Focus();  }" />
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                <div style="text-align:center; font-size:medium; font-family:Segoe UI Light;">
                    ...
                    <div align="center" class="font1">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxMemo ID="RejectMemo" runat="server" Height="50px" Width="500px" 
                                    MaxLength="255">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <dx:ASPxButton ID="BtnDel" runat="server" ClientInstanceName="BtnDel"
                                    Text="REJECT" Theme="MetropolisBlue" Width="75px" AutoPostBack="true">
                                </dx:ASPxButton>                       
                                <dx:ASPxButton ID="BtnCancel" runat="server" AutoPostBack="False" ClientInstanceName="BtnCancel"
                                    Text="BATAL" Theme="MetropolisBlue" Width="75px" CausesValidation="False">
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Reject Permintaan Dana</td>
</tr>
</table>
</div>
...
<tr>
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            ShowHeaderWhenEmpty="True" PageSize="50" ShowFooter="False" 
            AllowPaging="True">
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="Deskripsi" HeaderText="Deskripsi" HeaderStyle-Width="350px" ItemStyle-Width = "350px"/>
                ...
                <asp:BoundField DataField="RejectBy" HeaderText="PD Reject By" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="TimeReject" HeaderText="PD Reject On" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:ButtonField CommandName="BtnUpdate" Text="SELECT"  HeaderStyle-Width="45px" />                                          
                <asp:ButtonField CommandName="BtnReject" Text="REJECT" HeaderStyle-Width="45px" />
            </Columns>
