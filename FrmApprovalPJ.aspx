<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmApprovalPJ.aspx.vb" Inherits="AIS.FrmApprovalPJ" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Approval Pertanggungjawaban Dana (KK)</td>
</tr>
</table>
</div>
...
<%--<tr>
    ...
    <td>
        <asp:TextBox ID="TxtFind" runat="server" Width="300px" 
            placeholder="Cari berdasarkan No PD" CssClass="font1"></asp:TextBox>
    </td>
    <td>
    ...
    <td>
        <dx:ASPxComboBox ID="DDLField1" runat="server" 
            ...
            <Items>
                ...
                <dx:ListEditItem Text="No. PJ" Value="NoPJ" />
                <dx:ListEditItem Text="Tanggal PJ" Value="TglPJ" />
                <dx:ListEditItem Text="Total PJ" Value="TotalPJ" />
            </Items>
        </dx:ASPxComboBox>
    </td>
    <td>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="Deskripsi" HeaderText="Deskripsi" HeaderStyle-Width="450px" ItemStyle-Width = "450px"/>
                ...
                <asp:BoundField DataField="NoPJ" HeaderText="No. PJ" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="TglPJ" HeaderText="Tgl PJ" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="TotalPJ" HeaderText="Total PJ (Rp)" HeaderStyle-Width="100px" ItemStyle-Width = "100px"
                    DataFormatString="{0:N0}" ItemStyle-HorizontalAlign="Right">                        
                </asp:BoundField>
                <asp:BoundField DataField="PjApprovedByKK" HeaderText="PJ Approved By (KK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="PjTimeApprovedKK" HeaderText="PJ Approved On (KK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
