Public Class FrmDPPD
    ...
    Protected Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Session("Print") = Trim(DDLJob.Text) + "|" + DDLAlokasi.Value + "|" + If(CbAll.Checked = True, "All", PrdAwal.Date + "#" & PrdAkhir.Date)
        Response.Redirect("FrmRptDPPD.aspx")
