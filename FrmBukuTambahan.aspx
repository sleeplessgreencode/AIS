<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmBukuTambahan.aspx.vb" Inherits="AIS.FrmBukuTambahan" %>
...
<div class="title" 
        style="border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #C0C0C0; margin-bottom: 5px;">Buku Tambahan</div>
...
<tr>
    ...
    <td>:</td>
    <td colspan="5">
        <dx:ASPxComboBox ID="DDLAccount" runat="server" 
            ClientInstanceName="DDLAccount" Theme="MetropolisBlue" Width="100%">
            <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" SetFocusOnError="True">
                <RequiredField IsRequired="true" />
            </ValidationSettings>
        </dx:ASPxComboBox>
