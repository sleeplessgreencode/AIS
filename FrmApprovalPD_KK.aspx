<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmApprovalPD_KK.aspx.vb" Inherits="AIS.FrmApprovalPD_KK" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Approval Permintaan Dana (KK)</td>
</tr>
</table>
</div>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="ApprovedByKK" HeaderText="PD Approved By (KK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="TimeApprovedKK" HeaderText="PD Approved On (KK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
