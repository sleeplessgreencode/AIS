<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmApprovalPD_DK.aspx.vb" Inherits="AIS.FrmApprovalPD_DK" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Approval Permintaan Dana (DK)</td>
</tr>
</table>
</div>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="TimeApprovedDK" HeaderText="PD Approved On (DK)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
