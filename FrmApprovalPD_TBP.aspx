<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmApprovalPD_TBP.aspx.vb" Inherits="AIS.FrmApprovalPD_TBP" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Approval Permintaan Dana (TBP)</td>
</tr>
</table>
</div>
    ...
    <td>  
        <asp:GridView ID="GridPD" runat="server" AutoGenerateColumns="False"               
            ...
            <Columns>                        
                ...
                <asp:BoundField DataField="ApprovedByTBP" HeaderText="PD Approved By (TBP)" HeaderStyle-Width="80px" ItemStyle-Width = "80px">                    
                </asp:BoundField>
                <asp:BoundField DataField="TimeApprovedTBP" HeaderText="PD Approved On (TBP)" HeaderStyle-Width="80px" ItemStyle-Width = "80px"
                    DataFormatString="{0:dd-MMM-yyyy}">                        
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
