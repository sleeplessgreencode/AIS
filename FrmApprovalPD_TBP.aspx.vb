Public Class FrmApprovalPD_TBP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("User") = "" Then
            ...
            Exit Sub
        Else
            If CheckAkses1(Session("User").ToString.Split("|")(1), "ApprovalPD_TBP") = False Then
                Response.Redirect("Default.aspx")
                Exit Sub
            End If
        End If
    ...
    Private Sub BindGrid()
        ...
        With CmdGrid
            ...
            .CommandText = "SELECT * FROM PdHdr WHERE JobNo=@P1 " + GetFilter1() + GetFilter2() + " AND ApprovedByKK IS NOT NULL ORDER BY TglPD DESC, NoPD DESC"
    ...
    Private Sub GridPD_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridPD.RowCommand
        If e.CommandName = "BtnUpdate" Then
            ...
            If SelectRecord.Cells(9).Text = "&nbsp;" Then
                Session("PD") = "UPD_APPROVALPD_TBP|" & DDLJob.Text & "|" & SelectRecord.Cells(0).Text & "|" & "FrmApprovalPD_TBP.aspx"

            Else
                Session("PD") = "SEE_APPROVALPD_TBP|" & DDLJob.Text & "|" & SelectRecord.Cells(0).Text & "|" & "FrmApprovalPD_TBP.aspx"
            End If

            If Left(SelectRecord.Cells(0).Text, 5) = "PDKSO" Or Left(SelectRecord.Cells(0).Text, 5) = "PDRKD" Then
                Response.Redirect("FrmEntryRKD.aspx")
            Else
    ...
    Protected Sub BtnDel_Click(sender As Object, e As EventArgs) Handles BtnDel.Click
        ...
        With CmdEdit
            .Connection = Conn
            .CommandType = CommandType.Text
            .CommandText = "UPDATE PdHdr SET ApprovedByTBP=@P1,TimeApprovedTBP=@P2 WHERE NoPD=@P3"
