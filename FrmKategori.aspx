<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmKategori.aspx.vb" Inherits="AIS.FrmKategori" %>
...
<table>
<tr>
    <td style="font-size:30px; text-decoration:underline">Daftar Kategori</td>
</tr>
</table>
</div>
...
<tr>
    ...
    <td>    
        <asp:TextBox ID="TxtKategori" runat="server" Width="300px" autocomplete="off" 
            MaxLength="30" CssClass="font1" TabIndex="1"></asp:TextBox>
    </td>
</tr>
<tr>
    <td>Keterangan</td>
    <td style="text-align:center">:</td>
    <td>
        <asp:TextBox ID="TxtKeterangan" runat="server" Width="500px" autocomplete="off" CssClass="font1" MaxLength="255" TabIndex="2"></asp:TextBox>
    </td>
</tr>
<tr>
    <td>
    ...
    <td>
        <dx:ASPxButton ID="BtnSave" runat="server" Text="SIMPAN" 
            Width="75px" Theme="MetropolisBlue" TabIndex="3">
        </dx:ASPxButton>     
...
<tr>
    <td>
        <asp:GridView ID="GridData" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="KategoriId" HeaderText="Kategori" HeaderStyle-Width="300px"
