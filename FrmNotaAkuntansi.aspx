<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="FrmNotaAkuntansi.aspx.vb" Inherits="AIS.FrmNotaAkuntansi" %>
...
<div class="title" 
        style="border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #C0C0C0; margin-bottom: 5px;">Nota Akuntasi</div>
...
<tr>
    ...
    <td>:</td>
    <td>
        <dx:ASPxComboBox ID="DDLSite" runat="server" ValueType="System.String" AutoPostBack="true" 
...
<td>  
    <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False"               
        ...
        <Columns>     
            ...
            <asp:BoundField DataField="Nama" HeaderText="Identitas" HeaderStyle-Width="250px"
                ItemStyle-Width="250px" SortExpression="Nama">                        
            </asp:BoundField>
            ...
            <asp:ButtonField CommandName="BtnPrint" Text="PRINT" HeaderStyle-Width="45px" ItemStyle-HorizontalAlign="Center">                                          
            </asp:ButtonField>
        </Columns>
